...
function Input(_ref) {
  var id = _ref.id,
      ...
      props = _objectWithoutProperties(_ref, ["id", "addonAfter", "addonBefore", "disabled", "value", "onChange", "size", "prefix", "placeholder", "suffix", "status", "type", "width", "style", "className"]);
